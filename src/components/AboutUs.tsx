        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80" 
                alt="RRCM Construtora - Equipe trabalhando" 
          ...
          <div className="lg:w-1/2">
            ...
            <a 
              href="#contact" 
              className="bg-[#0086c3] hover:bg-[#00537a] text-white px-6 py-3 rounded-md transition-all flex items-center justify-center gap-2 font-medium inline-flex animate-fade-in" 
